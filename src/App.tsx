...
function WorkPage({ setPage }) {
  ...
  const projects = [
    ...
    {title:'NaYF₄:Yb,Er@NaYF₄ NP Upconversion',year:'2025',desc:'Lab research and prototype development for core-shell upconversion nanoparticles — NIR-to-visible photon upconversion applications.',image:'https://images.unsplash.com/photo-1614935151651-0bea6508db6b?auto=format&fit=crop&q=80',technologies:['Nanoparticle Synthesis','Spectroscopy','MATLAB','Materials Science'],link:'#',category:'Research'},
